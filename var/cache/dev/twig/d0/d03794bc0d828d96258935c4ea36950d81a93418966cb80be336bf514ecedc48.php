...
<div class=\"container\">
 <div class=\"mail-box\">
        ...
        echo "\" class=\"btn mini tooltips\">
                          ...
                          ";
        // line 54
        $this->loadTemplate("FOSMessageBundle:Message:threads_list.html.twig", "@Front/Message/sent.html.twig", 54)->display(array_merge($context, array("threads" => (isset($context["threads"]) ? $context["threads"] : $this->getContext($context, "threads")))));
        // line 55
        echo "
                      </div>
                  </aside>
