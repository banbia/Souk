...
class __TwigTemplate_088b025650efb0082080698863cd33b6ade245aa0d4d3b5427552636c7f1b152 extends Twig_Template
{
    private $source;
...
<div class=\"container\">
 <div class=\"mail-box\">
        ...
        echo "\" class=\"btn mini tooltips\">
                          ...
                          ";
        // line 54
        $this->loadTemplate("FOSMessageBundle:Message:threads_list.html.twig", "FrontBundle:Message:sent.html.twig", 54)->display(array_merge($context, array("threads" => (isset($context["threads"]) || array_key_exists("threads", $context) ? $context["threads"] : (function () { throw new Twig_Error_Runtime('Variable "threads" does not exist.', 54, $this->source); })()))));
        // line 55
        echo "
                      </div>
                  </aside>
