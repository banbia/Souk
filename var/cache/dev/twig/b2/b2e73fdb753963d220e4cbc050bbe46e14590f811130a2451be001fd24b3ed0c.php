...
class __TwigTemplate_4327d4fad3408d5efb5a764b24b8ed9fddd8c7926d80938df7c463ecf814945d extends Twig_Template
{
...
<div class=\"container\">
 <div class=\"mail-box\">
        ...
        echo "\" class=\"btn mini tooltips\">
                          ...
                          ";
        // line 55
        $this->loadTemplate("FOSMessageBundle:Message:threads_list.html.twig", "FrontBundle:Message:sent.html.twig", 55)->display(array_merge($context, array("threads" => (isset($context["threads"]) ? $context["threads"] : $this->getContext($context, "threads")))));
        // line 56
        echo "
                      </div>
                  </aside>
