...
class __TwigTemplate_fed47681645f1c4bff32c3d403c4efd1aafffc577c2c9e3c1026655458029973 extends Twig_Template
{
    ...
    <div class=\"row\">
        <div class=\"col-md-6\">
            ";
        // line 9
        echo         $this->env->getRuntime('Symfony\Bridge\Twig\Form\TwigRenderer')->renderBlock(($context["formSignal"] ?? $this->getContext($context, "formSignal")), 'form_start');
        echo "
            ";
        // line 10
        echo $this->env->getRuntime('Symfony\Bridge\Twig\Form\TwigRenderer')->searchAndRenderBlock($this->getAttribute(($context["formSignal"] ?? $this->getContext($context, "formSignal")), "contenu", array()), 'errors');
        echo "
            ";
        // line 11
        echo $this->env->getRuntime('Symfony\Bridge\Twig\Form\TwigRenderer')->searchAndRenderBlock($this->getAttribute(($context["formSignal"] ?? $this->getContext($context, "formSignal")), "contenu", array()), 'widget', array("attr" => array("class" => "comment form-control")));
        echo "
            <button type=\"submit\" class=\"btn btn-danger pull-right\"><i class=\"fa fa-flag-o\"></i> Signaler </button>
            ";
        // line 13
        echo         $this->env->getRuntime('Symfony\Bridge\Twig\Form\TwigRenderer')->renderBlock(($context["formSignal"] ?? $this->getContext($context, "formSignal")), 'form_end');
        echo "
            <br>
            <br>
        </div>
...
{% block body %}
    ...
    <!-- /row -->
{% endblock %}", "FrontBundle:signalsEvs:signalEvs.html.twig", "C:\\Users\\Soumaya\\Documents\\GitHub\\Souk\\src\\Souk\\FrontBundle/Resources/views/signalsEvs/signalEvs.html.twig");
    }
}
