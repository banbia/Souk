...
class __TwigTemplate_a81d6903aee513e2795dece8f82cf186577e9ac4055e271b1f737de928dc313e extends Twig_Template
{
    ...
    <div class=\"row\">
        <div class=\"col-md-12\">
            ...
            <a href=\"";
        // line 7
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("signalsEvsN_new", array("evennement" => ($context["evennement"] ?? $this->getContext($context, "evennement")))), "html", null, true);
        ...
        <div class=\"col-md-6\">
            ";
        // line 12
        echo         $this->env->getRuntime('Symfony\Bridge\Twig\Form\TwigRenderer')->renderBlock(($context["formCommentaire"] ?? $this->getContext($context, "formCommentaire")), 'form_start');
        echo "
                ";
        // line 13
        echo $this->env->getRuntime('Symfony\Bridge\Twig\Form\TwigRenderer')->searchAndRenderBlock($this->getAttribute(($context["formCommentaire"] ?? $this->getContext($context, "formCommentaire")), "contenu", array()), 'errors');
        echo "
                ";
        // line 14
        echo $this->env->getRuntime('Symfony\Bridge\Twig\Form\TwigRenderer')->searchAndRenderBlock($this->getAttribute(($context["formCommentaire"] ?? $this->getContext($context, "formCommentaire")), "contenu", array()), 'widget', array("attr" => array("class" => "comment form-control")));
        echo "
                <button type=\"submit\" class=\"btn sign pull-right\"><i class=\"fa fa-commenting-o\"></i> Commenter </button>
            ";
        // line 16
        echo         $this->env->getRuntime('Symfony\Bridge\Twig\Form\TwigRenderer')->renderBlock(($context["formCommentaire"] ?? $this->getContext($context, "formCommentaire")), 'form_end');
        echo "
            <br>
            <br>
        </div>
    ...
    <div class=\"row\">
        ...
        $context['_seq'] = twig_ensure_traversable(($context["coms_Evs"] ?? $this->getContext($context, "coms_Evs")));
...
", "FrontBundle:evennements:new_commentairesEvs.html.twig", "C:\\Users\\Soumaya\\Documents\\GitHub\\Souk\\src\\Souk\\FrontBundle/Resources/views/evennements/new_commentairesEvs.html.twig");
    }
}
