...
<div class=\"container\">
 <div class=\"mail-box\">
        ...
        echo "\" class=\"btn mini tooltips\">
                          ...
                          ";
        // line 53
        $this->loadTemplate("FOSMessageBundle:Message:threads_list.html.twig", "@Front/Message/deleted.html.twig", 53)->display(array_merge($context, array("threads" => (isset($context["threads"]) ? $context["threads"] : $this->getContext($context, "threads")))));
        // line 54
        echo "
                      </div>
                  </aside>
