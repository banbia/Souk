...
class __TwigTemplate_ae8fa65e58e36278a056cc07f96dbc8e2897aa1dff8056a80009a3478566fee9 extends Twig_Template
{
    private $source;
...
<p>";
        // line 7
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->getTranslator()->transChoice("threads_found", twig_length_filter($this->env, (isset($context["threads"]) || array_key_exists("threads", $context) ? $context["threads"] : (function () { throw new Twig_Error_Runtime('Variable "threads" does not exist.', 7, $this->source); })())), array("%num%" => twig_length_filter($this->env, (isset($context["threads"]) || array_key_exists("threads", $context) ? $context["threads"] : (function () { throw new Twig_Error_Runtime('Variable "threads" does not exist.', 7, $this->source); })()))), "FOSMessageBundle");
        // line 9
        echo "</p>

";
        // line 11
        $this->loadTemplate("FOSMessageBundle:Message:threads_list.html.twig", "FrontBundle:Message:search.html.twig", 11)->display(array_merge($context, array("threads" => (isset($context["threads"]) || array_key_exists("threads", $context) ? $context["threads"] : (function () { throw new Twig_Error_Runtime('Variable "threads" does not exist.', 11, $this->source); })()))));
        // line 12
        echo "
";
    ...
    {
        return array (  69 => 12,  67 => 11,  63 => 9,  61 => 7,  56 => 5,  53 => 4,  44 => 3,  15 => 1,);
    }
