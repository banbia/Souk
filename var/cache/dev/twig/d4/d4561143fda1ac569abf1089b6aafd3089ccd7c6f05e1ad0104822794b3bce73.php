...
class __TwigTemplate_ffbcb625c36b7c57ed5efccfaf357c8937bbf4c4124ce0cbb54b6ebc07a2a2a8 extends Twig_Template
{
    private $source;
...
<div class=\"container\">
 <div class=\"mail-box\">
        ...
        echo "\" class=\"btn mini tooltips\">
                          ...
                          ";
        // line 54
        $this->loadTemplate("FOSMessageBundle:Message:threads_list.html.twig", "FrontBundle:Message:inbox.html.twig", 54)->display(array_merge($context, array("threads" => (isset($context["threads"]) || array_key_exists("threads", $context) ? $context["threads"] : (function () { throw new Twig_Error_Runtime('Variable "threads" does not exist.', 54, $this->source); })()))));
        // line 55
        echo "
                      </div>
                  </aside>
...
";
    ...
    {
        return array (  130 => 55,  128 => 54,  117 => 46,  96 => 28,  89 => 24,  80 => 20,  74 => 16,  72 => 15,  68 => 14,  56 => 5,  53 => 4,  44 => 3,  15 => 1,);
    }
