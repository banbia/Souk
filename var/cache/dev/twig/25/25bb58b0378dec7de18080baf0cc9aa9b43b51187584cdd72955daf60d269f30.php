...
class __TwigTemplate_2a8e759e47d0d0c876eac6aafd9cfb1fa94e9b63aad229f6a73832bc393173fd extends Twig_Template
{
            ...
            <table class=\"table table-condensed\">
                ...
                {% for a in ev %}
                    <tr>
                        ...
                        <td>{{ a.lieu }}</td>
                        <td>{{ a.prix }}</td>
                        <td><a href=\"{{ path('show',{'evennement':a.id}) }}\">Consulter Signals</a></td>
                    </tr>
                {% endfor %}
                </tbody>
            </table>
            ...
            <table class=\"table table-condensed\">
                ...
                {% for a in anc %}
                    <tr>
                       ...
                       <td><a href=\"{{ path('consulter',{'annonce':a.id}) }}\">Consulter Signals </a></td>
