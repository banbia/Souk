...
class Evennements extends \Souk\BackBundle\Entity\Evennements implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Souk\\BackBundle\\Entity\\Evennements' . "\0" . 'id', '' . "\0" . 'Souk\\BackBundle\\Entity\\Evennements' . "\0" . 'titre', '' . "\0" . 'Souk\\BackBundle\\Entity\\Evennements' . "\0" . 'description', '' . "\0" . 'Souk\\BackBundle\\Entity\\Evennements' . "\0" . 'dateDeb', '' . "\0" . 'Souk\\BackBundle\\Entity\\Evennements' . "\0" . 'dateFin', '' . "\0" . 'Souk\\BackBundle\\Entity\\Evennements' . "\0" . 'lieu', '' . "\0" . 'Souk\\BackBundle\\Entity\\Evennements' . "\0" . 'prix', '' . "\0" . 'Souk\\BackBundle\\Entity\\Evennements' . "\0" . 'commentaires', '' . "\0" . 'Souk\\BackBundle\\Entity\\Evennements' . "\0" . 'client', '' . "\0" . 'Souk\\BackBundle\\Entity\\Evennements' . "\0" . 'commercial', '' . "\0" . 'Souk\\BackBundle\\Entity\\Evennements' . "\0" . 'reservations', '' . "\0" . 'Souk\\BackBundle\\Entity\\Evennements' . "\0" . 'signals', '' . "\0" . 'Souk\\BackBundle\\Entity\\Evennements' . "\0" . 'etat'];
        }
