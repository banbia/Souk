    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/annonces')) {
            ...
            if ('/annonces' === $trimmedPathinfo) {
                ...
                return array (  '_controller' => 'Souk\\FrontBundle\\Controller\\AnnoncesController::indexAction',  '_route' => 'commercial_annonces_index',);
            }
            ...
            if ('/annonces/new' === $pathinfo) {
                ...
                return array (  '_controller' => 'Souk\\FrontBundle\\Controller\\AnnoncesController::newAction',  '_route' => 'annonces_new',);
            }
            not_annonces_new:
            ...
            if (preg_match('#^/annonces/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'annonces_edit')), array (  '_controller' => 'Souk\\FrontBundle\\Controller\\AnnoncesController::editAction',));
            }
            not_annonces_edit:

            // annonces_delete
            if (preg_match('#^/annonces/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                if ('DELETE' !== $canonicalMethod) {
                    $allow[] = 'DELETE';
                    goto not_annonces_delete;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'annonces_delete')), array (  '_controller' => 'Souk\\FrontBundle\\Controller\\AnnoncesController::deleteAction',));
            }
            not_annonces_delete:
