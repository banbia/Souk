...
class __TwigTemplate_a98aedddad045c51e32f5935df877730cd79e0df000777e33a09c15e57ee84b7 extends Twig_Template
{
...
";
    ...
    public function block_body($context, array $blocks = array())
    {
        ...
        <li><a href=\"\">";
        // line 19
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["annonce"] ?? null), "categorie", array()), "designation", array()), "html", null, true);
        echo "</a></li>
        <li>";
        // line 20
...
\t\t\t\t\t</span>
        ...
        // line 88
        echo $this->getAttribute(($context["annonce"] ?? null), "description", array());
        echo "
                </p>
            </div>
             <div class=\"product-single-w3l\">
            ...
            ";
        // line 93
        if ($this->getAttribute($this->getAttribute(($context["annonce"] ?? null), "commercial", array()), "adresse", array())) {
            echo "<span class=\"phone\"><i class=\"fa fa-map-marker\"></i> ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["annonce"] ?? null), "commercial", array()), "adresse", array()), "html", null, true);
            echo "</span>";
        }
        // line 94
        echo "            ";
        if ($this->getAttribute($this->getAttribute(($context["annonce"] ?? null), "commercial", array()), "mobile", array())) {
            echo "<span class=\"phone\"><i class=\"fa fa-phone\"></i> ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["annonce"] ?? null), "commercial", array()), "mobile", array()), "html", null, true);
            echo "</span>";
        }
        // line 95
        echo "            ";
        if ($this->getAttribute($this->getAttribute(($context["annonce"] ?? null), "commercial", array()), "email", array())) {
            echo "<span class=\"phone\"><i class=\"fa fa-envelope\"></i> ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["annonce"] ?? null), "commercial", array()), "email", array()), "html", null, true);
            echo "</span>";
        }
        // line 96
        echo "                </p>
...
";
        // line 109
        if (($this->getAttribute($this->getAttribute(($context["annonce"] ?? null), "commercial", array()), "id", array()) != $this->getAttribute($this->getAttribute(($context["app"] ?? null), "user", array()), "id", array()))) {
            // line 110
...
";
    ...
    ";
        // line 185
        echo $this->env->getRuntime('Symfony\Bridge\Twig\Extension\HttpKernelRuntime')->renderFragment(Symfony\Bridge\Twig\Extension\HttpKernelExtension::controller("FrontBundle:Annonces:new", array("annonce" => $this->getAttribute(($context["annonce"] ?? null), "id", array()))));
        echo "
...
";
    ...
    {
        return array (  372 => 206,  368 => 205,  364 => 204,  360 => 203,  344 => 189,  341 => 188,  334 => 185,  305 => 159,  289 => 146,  285 => 145,  281 => 144,  275 => 141,  271 => 140,  267 => 139,  252 => 127,  247 => 124,  243 => 122,  236 => 117,  229 => 112,  227 => 111,  224 => 110,  222 => 109,  218 => 107,  206 => 96,  199 => 95,  192 => 94,  186 => 93,  178 => 88,  154 => 71,  147 => 67,  128 => 51,  114 => 40,  109 => 38,  104 => 36,  99 => 34,  94 => 32,  89 => 30,  76 => 20,  72 => 19,  68 => 18,  65 => 17,  63 => 16,  60 => 15,  53 => 12,  48 => 10,  44 => 9,  40 => 8,  33 => 3,  30 => 2,  11 => 1,);
    }
