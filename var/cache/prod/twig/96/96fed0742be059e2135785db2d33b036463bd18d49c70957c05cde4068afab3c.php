...
class __TwigTemplate_e2583fe16f7f946d0f7090c602498317c92ac5292aa87e5e3539e56a7e5aa26b extends Twig_Template
{
    ...
    <div class=\"row\">
        <div class=\"col-md-12\">
            ...
            <a href=\"";
        // line 7
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("signalsEvsN_new", array("evennement" => ($context["evennement"] ?? null))), "html", null, true);
        ...
        echo "
                ";
        // line 13
        echo $this->env->getRuntime('Symfony\Bridge\Twig\Form\TwigRenderer')->searchAndRenderBlock($this->getAttribute(($context["formCommentaire"] ?? null), "contenu", array()), 'errors');
        echo "
                ";
        // line 14
        echo $this->env->getRuntime('Symfony\Bridge\Twig\Form\TwigRenderer')->searchAndRenderBlock($this->getAttribute(($context["formCommentaire"] ?? null), "contenu", array()), 'widget', array("attr" => array("class" => "comment form-control")));
        echo "
