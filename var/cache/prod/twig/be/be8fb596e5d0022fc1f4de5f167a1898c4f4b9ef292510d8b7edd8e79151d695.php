...
class __TwigTemplate_c906de376e70b249153800adcf0064b1fee1cfd573de889abc143107adc24c39 extends Twig_Template
{
    ...
    <table>
        <tbody>
            <tr>
                ...
                <td>";
        // line 10
        echo twig_escape_filter($this->env, $this->getAttribute(($context["annonce"] ?? null), "id", array()), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Titre</th>
    ...
    <ul>
        ...
        <li>
            <a href=\"";
        // line 40
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("annonces_edit", array("id" => $this->getAttribute(($context["annonce"] ?? null), "id", array()))), "html", null, true);
        echo "\">Edit</a>
        </li>
        <li>
            ";
...
";
    ...
    {
        return new Twig_Source("", "BackBundle:commercial/annonces:show.html.twig", "/opt/lampp/htdocs/dev/souk/src/Souk/BackBundle/Resources/views/commercial/annonces/show.html.twig");
    }
}
