...
class __TwigTemplate_969a8878a45f301734a3abe80a0ce34a944dc8cce1c91885b764a9d764b9a194 extends Twig_Template
{
    ...
    <ul>
        ...
        <li>
            <a href=\"";
        // line 51
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("evennements_delete", array("id" => $this->getAttribute(($context["evennement"] ?? null), "id", array()))), "html", null, true);
        echo "\">Delete</a>
    ...
    ";
        // line 56
        echo $this->env->getRuntime('Symfony\Bridge\Twig\Extension\HttpKernelRuntime')->renderFragment(Symfony\Bridge\Twig\Extension\HttpKernelExtension::controller("FrontBundle:Evennements:newEvs", array("evennement" => $this->getAttribute(($context["evennement"] ?? null), "id", array()))));
        echo "
